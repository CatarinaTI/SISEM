...
<ResourceModel:App xmi:version="2.0" xmlns:xmi="http://www.omg.org/XMI" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:ResourceModel="http://www.infineon.com/Davex/Resource.ecore" name="PWM" URI="http://resources/4.1.12/app/PWM/0" description="Generates a PWM using one timer slice of CCU4 or CCU8" mode="NOTSHARABLE" version="4.1.12" minDaveVersion="4.3.2" instanceLabel="PWM_0" appLabel="" containingProxySignal="true">
  ...
  <virtualSignals name="event_compare_match" URI="http://resources/4.1.12/app/PWM/0/vs_pwm_ccu8_cc8_slice_compare_match_interrupt" hwSignal="cmd1s_cmu1s" hwResource="//@hwResources.0" required="false" visible="true"/>
  ...
  <virtualSignals name="event_compare_match" URI="http://resources/4.1.12/app/PWM/0/vs_pwm_ccu4_cc4_slice_compare_match_interrupt" hwSignal="cmds_cmus" hwResource="//@hwResources.1" visible="true"/>
  ...
  <connections URI="http://resources/4.1.12/app/PWM/0/http://resources/4.1.12/app/PWM/0/vs_pwm_ccu4_cc4_slice_compare_match_interrupt/http://resources/4.1.24/app/ADC_MEASUREMENT/0/vs_adc_measurement_bgreqgtsel" sourceSignal="event_compare_match" targetSignal="gating_input" srcVirtualSignal="//@virtualSignals.6">
    <downwardMapList xsi:type="ResourceModel:VirtualSignal" href="../../ADC_MEASUREMENT/v4_1_24/ADC_MEASUREMENT_0.app#//@virtualSignals.184"/>
    <targetVirtualSignal href="../../ADC_MEASUREMENT/v4_1_24/ADC_MEASUREMENT_0.app#//@virtualSignals.184"/>
  </connections>
</ResourceModel:App>
